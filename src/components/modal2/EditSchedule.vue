        ...
        <form action="#">
           <div class="form-row" style="margin-left: 7rem;">
              <div class="input-data">
                 <input name="date" type="date" style="width: 120px;" onfocus="(this.type='date')" onblur="if(!this.value)this.type='text'">
             ...
             <label style="left:0px; color:#0099BE">User &nbsp;&nbsp;</label>
                 <select name="cars" class="btn btn-secondary" style="background-color: #0099BE;" id="cars">
                 <div class="dropdown-menu">
  <option style="background-color: aliceblue; color: black;" value="volvo">Volvo</option>
  <option style="background-color: aliceblue; color: black;" value="saab">Saab</option>
  <option style="background-color: aliceblue; color: black;" value="mercedes">Mercedes</option>
  <option  style="background-color: aliceblue; color: black;" >Audi</option></div>
</select>               
           </div>
           <div class="form-row" style="margin-left:8rem;">
